  ...
  return (
    <>
      ...
      <div className={styles.HeroContainer}>
        <div className={styles.HeroText}>
          ...
          <div className={styles.HeroBtnGroup}>
            <div style={{ color: "#fff" }} className={styles.ColorBtn1}>
              Explore
            </div>
      ...
      <div className={styles.textAreaSection}>
        <div style={{ color: "#5c5c5c" }} className={styles.textArea3}>
      ...
      <div className={styles.centerContainer}>
        <div className={styles.visionContainer}>
          <div style={{ color: "#881FEF" }} className={styles.visionHeadline}>
            Our Vision
          </div>
          <div style={{ color: "#666" }} className={styles.visionBody}>
